...
describe('RQFile', function () {
  ...
  describe('CacheFile', function () {
    ...
    it('testCacheFileOlderRemote', function (done) {
      c.addCachedFile('/testfile', function () {
        c.remoteTree.open('/testfile', function (err, file) {
          expect(err).toBeFalsy();
          c.localTree.open('/testfile', function (err, origLocal) {
            expect(err).toBeFalsy();
              ...
              c.testTree.open('/testfile', function (err, file) {
                ...
                file.cacheFile(function (err) {
                  ...
                  file.close(function (err) {
                    ...
                    c.localTree.open('/testfile', function (err, file) {
                      expect(err).toBeFalsy();
                      expect(file.created()).not.toEqual(origLocal.created());
                      expect(file.lastModified()).not.toEqual(origLocal.lastModified());
                      done();
                    });
                  });
                });
    ...
    it('testCacheFileOlderRemoteModifiedLocal', function (done) {
      c.addCachedFile('/testfile', function () {
        c.remoteTree.open('/testfile', function (err, file) {
          expect(err).toBeFalsy();
          file.setLastModified(file.lastModified() - 10000);
          file.close(function (err) {
            ...
            c.localTree.open('/testfile', function (err, origLocal) {
              expect(err).toBeFalsy();
              origLocal.setLastModified(origLocal.lastModified() + 10000);
              origLocal.close(function (err) {
                expect(err).toBeFalsy();
                c.testTree.open('/testfile', function (err, file) {
                  expect(err).toBeFalsy();
                  file.cacheFile(function (err) {
                    ...
                    file.close(function (err) {
                      ...
                      c.localTree.open('/testfile', function (err, file) {
                        expect(err).toBeFalsy();
                        expect(file.created()).toEqual(origLocal.created());
                        expect(file.lastModified()).toEqual(origLocal.lastModified());
                        done();
                      });
                    });
                  });
