...
function parseNegotiateMessage(buf) {
  ...
  if (type !== consts.NTLMSSP_NEGOTIATE_MESSAGE) {
    logger.warn('invalid NTLMSSP message type: expected: %s, actual: %s', consts.MESSAGE_TYPE_TO_STRING[consts.NTLMSSP_NEGOTIATE_MESSAGE], consts.MESSAGE_TYPE_TO_STRING[type]);
    return null;
  }
...
function parseAuthenticateMessage(buf) {
  ...
  if (type !== consts.NTLMSSP_AUTHENTICATE_MESSAGE) {
    logger.warn('invalid NTLMSSP message type: expected: %s, actual: %s', consts.MESSAGE_TYPE_TO_STRING[consts.NTLMSSP_AUTHENTICATE_MESSAGE], consts.MESSAGE_TYPE_TO_STRING[type]);
    return null;
  }
