              ...
              destTree.open(destPath, function (err, destFile) {
                if (err) {
                  ...
                  copy(file, destFile, deleteSrc, function (err) {
                    destFile.close(function (ignore) {
                      callback(err);
                    });
                  });
...
/**
 * Set the underlying name of this file, after a successful rename.
 *
 * @param newName new name
 */
File.prototype.setFileName = function (newName) {
