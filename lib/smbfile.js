 ...
 * @constructor
 */
function SMBFile(spiFile, smbTree, openAction, fid) {
 ...
 * @return {Number} type
 */
SMBFile.prototype.getType = function () {
  return this.spiFile.getType();
};
...
SMBFile.prototype.delete = function (cb) {
  ...
  this.smbTree.notifyChangeListeners(consts.FILE_ACTION_REMOVED, this.getPath());
};
...
SMBFile.prototype.flush = function (cb) {
  ...
  // notify registered change listeners
  this.smbTree.notifyChangeListeners(consts.FILE_ACTION_MODIFIED, this.getPath());
};
