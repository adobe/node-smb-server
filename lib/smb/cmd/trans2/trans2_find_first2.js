...
var emptyShortNameBytes = new Buffer(2 * 12).fill(0); // 8.3 unicode
...
function handle(msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, cb) {
  ...
  logger.debug('[%s] searchAttributes: %s, searchCount: %d, flags: %s, informationLevel: %s, searchStorageType: %d, fileName: %s', consts.TRANS2_SUBCOMMAND_TO_STRING[commandId].toUpperCase(), searchAttributes.toString(2), searchCount, flags.toString(2), consts.FIND_INFORMATION_LEVEL_TO_STRING[informationLevel], searchStorageType, fileName);
  ...
  function processLookupResult(files, callback) {
    ...
    function process(file, index) {
      ...
      switch (informationLevel) {
        case consts.FIND_INFO_STANDARD:
          /*
        ...
        case consts.FIND_INFO_EA_SIZE:
           ...
           */
        case consts.FIND_INFO_EAS_FROM_LIST:
          /*
           ...
           */
          // todo implement
          logger.error('encountered unsupported informationLevel %s', consts.FIND_INFORMATION_LEVEL_TO_STRING[informationLevel]);
          callback(null, {
        ...
        case consts.FIND_FILE_DIRECTORY_INFO:
        ...
        case consts.FIND_FILE_FULL_DIRECTORY_INFO:
        ...
        case consts.FIND_FILE_NAMES_INFO:
        ...
        case consts.FIND_FILE_BOTH_DIRECTORY_INFO:
