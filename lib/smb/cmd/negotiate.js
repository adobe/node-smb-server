...
function handle(msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, cb) {
  ...
  if (!!server.config['smb2Support'] && msg.dialects.indexOf(SMB.DIALECT_SMB_2_X) > -1) {
    ...
    var out = put();
    out.word16le(0) // SecurityMode
      .word16le(0x02ff) // DialectRevision
  ...
  params.writeUInt32LE(
    SMB.CAP_STATUS32 | SMB.CAP_LEVEL2_OPLOCKS |
    SMB.CAP_NT_SMBS | SMB.CAP_NT_FIND |
    SMB.CAP_LOCK_AND_READ | SMB.CAP_RAW_MODE |
