...
function handle(msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, cb) {
  ...
  logger.debug('[%s] dialects: %s', consts.COMMAND_TO_STRING[commandId].toUpperCase(), msg.dialects.toString());
  ...
  params.writeUInt32LE(
    ...
    consts.CAP_INFOLEVEL_PASSTHRU | consts.CAP_RPC_REMOTE_APIS |
    consts.CAP_LARGE_READX | consts.CAP_LARGE_WRITEX,
    offset
  );
  offset += 4;
  // SystemTime
