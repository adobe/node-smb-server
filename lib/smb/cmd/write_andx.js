...
function handle(msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, cb) {
  ...
  logger.debug('[%s] fid: %d, offset: %d, timeout: %d, remaining: %d, dataLength: %d, dataOffset: %d', consts.COMMAND_TO_STRING[commandId], msg.fid, msg.offset, msg.timeout, msg.remaining, msg.dataLength, msg.dataOffset);
