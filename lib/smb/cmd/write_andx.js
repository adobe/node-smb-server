...
function handle(msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, cb) {
  ...
  logger.debug('[%s] fid: %d [fileName: %s], offset: %d, timeout: %d, remaining: %d, dataLength: %d, dataOffset: %d', SMB.COMMAND_TO_STRING[commandId].toUpperCase(), msg.fid, fileName, msg.offset, msg.timeout, msg.remaining, msg.dataLength, msg.dataOffset);
