...
function handle(msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, cb) {
  ...
  logger.debug('[%s][%s] totalParameterCount: %d, parameterCount: %d, totalDataCount: %d, dataCount: %d, setup: 0x%s', consts.COMMAND_TO_STRING[commandId], subCommand, msg.totalParameterCount, msg.parameterCount, msg.totalDataCount, msg.dataCount,  msg.setup.toString('hex'));
