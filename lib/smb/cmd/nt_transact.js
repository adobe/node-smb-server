...
function handle(msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, cb) {
  ...
  if (handler) {
    if (msg.subCommandId === 0x0004) {  // nt_transact_notify_change
      ...
      handler(msg, msg.subCommandId, subParams, subData, msg.parameterOffset, msg.dataOffset, createResponse, connection, server, function (result) {
...
function buildResponse(subResult) {
  ...
  if (subResult.status !== consts.STATUS_SUCCESS) {
    return {
