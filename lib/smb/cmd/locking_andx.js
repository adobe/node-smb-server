...
function handle(msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, cb) {
  ...
  logger.debug('[%s] fid: %d [fileName: %s], typeOfLock: %s, newOpLockLevel: %d, timeout: 0x%s, numberOfRequestedUnlocks: %d, numberOfRequestedLocks: %d', consts.COMMAND_TO_STRING[commandId].toUpperCase(), msg.fid, fileName, msg.typeOfLock.toString(2), msg.newOpLockLevel, msg.timeout.toString(16), msg.numberOfRequestedUnlocks, msg.numberOfRequestedLocks);
