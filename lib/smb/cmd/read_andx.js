...
function handle(msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, cb) {
  ...
  logger.debug('[%s] fid: %d, offset: %d, maxCountOfBytesToReturn: %d, minCountOfBytesToReturnL %d, timeout: %d, remaining: %d, offsetHigh: %d', consts.COMMAND_TO_STRING[commandId], msg.fid, msg.offset, msg.maxCountOfBytesToReturn, msg.minCountOfBytesToReturn, msg.timeout, msg.remaining, msg.offsetHigh);
