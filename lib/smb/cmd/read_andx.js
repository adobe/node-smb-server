...
function handle(msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, cb) {
  ...
  logger.debug('[%s] fid: %d [fileName: %s], offset: %d, maxCountOfBytesToReturn: %d, minCountOfBytesToReturn: %d, timeout: %d, remaining: %d, offsetHigh: %d', consts.COMMAND_TO_STRING[commandId].toUpperCase(), msg.fid, fileName, msg.offset, msg.maxCountOfBytesToReturn, msg.minCountOfBytesToReturn, msg.timeout, msg.remaining, msg.offsetHigh);
