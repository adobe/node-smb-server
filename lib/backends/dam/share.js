...
DAMShare.prototype.buildContentUrl = function (path, depth) {
  return this.protocol + '//' + this.host + ':' + this.port + DAM.ASSETS_API_PATH + utils.stripParentPath(this.path, DAM.DAM_ROOT_PATH) + path + '.json';
};

DAMShare.prototype.buildResourceUrl = function (path) {
  return this.protocol + '//' + this.host + ':' + this.port + DAM.ASSETS_API_PATH + utils.stripParentPath(this.path, DAM.DAM_ROOT_PATH) + path;
};
