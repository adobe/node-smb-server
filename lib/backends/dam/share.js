...
DAMShare.prototype.buildContentUrl = function (path, depth) {
  return this.protocol + '//' + this.host + ':' + this.port + this.contextPath + DAM.ASSETS_API_PATH + encodeURI(utils.stripParentPath(this.path, this.contextPath + DAM.DAM_ROOT_PATH) + path) + '.json';
};

DAMShare.prototype.buildResourceUrl = function (path) {
  return this.protocol + '//' + this.host + ':' + this.port + this.contextPath + DAM.ASSETS_API_PATH + encodeURI(utils.stripParentPath(this.path, this.contextPath + DAM.DAM_ROOT_PATH) + path);
};
