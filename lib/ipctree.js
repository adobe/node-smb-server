...
IPCTree.prototype.open = function (name, cb) {
  process.nextTick(function () { cb(new Error('not found')); });
};
...
IPCTree.prototype.createFile = function (name, cb) {
  process.nextTick(function () { cb(new Error('create failed')); });
};
...
IPCTree.prototype.delete = function (name, cb) {
  process.nextTick(function () { cb(new Error('delete failed')); });
};
...
IPCTree.prototype.rename = function (oldName, newName, cb) {
  process.nextTick(function () { cb(new Error('rename failed')); });
};
